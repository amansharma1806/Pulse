...
import { cancelAppointment, getAppointmentByDoctor, getAppointmentByPatient, scheduleAppointment } from '../../../Service/AppointmentService';
...
const fetchData=()=>{
   getAppointmentByDoctor(user.profileId).then((data) => {
